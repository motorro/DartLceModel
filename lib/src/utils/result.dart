...
class _Ok<D extends Object> implements Result<D> {
  final D? data;
  const _Ok(this.data);
...
class _Error<D extends Object> implements Result<D> {
...
extension ToResult<D extends Object> on Future<D?> {
  /// Converts [Future] and returns [Result]
...
extension ToFuture<D extends Object> on Result<D> {
  /// Converts [Result] to [Future]
